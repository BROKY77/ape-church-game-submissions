...
export const myGame: Game = {
    ...
    gameBackground: "/submissions/hi-lo/background.png",
    card: "/submissions/hi-lo/card.png",
    banner: "/submissions/hi-lo/banner.png",
    advanceToNextStateAsset: "/submissions/hi-lo/advance-button.png",
    themeColorBackground: "#22c55e",
    song: "/submissions/hi-lo/audio/song.mp3",
    payouts: {
        0: { 0: { 0: 10000 } },
    },
};
